      ...
      innerControl = (
        <View
          ...
          <Pressable
            ...
            onPress={() => {
              // goToCameraScreen(isFront);
              if (isFront) setFrontImageBase64('');
              else setBackImageBase64('');
            }}>
            <CrossBtn />
          </Pressable>
          <Image
    ...
    <View style={styles.mainContainer}>
      ...
      <ScrollView style={{flex: 1}}>
        <View style={{marginBottom: 12}}>
          ...
          <View style={{paddingTop: 12}}>{guidelineItems}</View>
        </View>
        <Card isFront={true} />
        <Card isFront={false} />
      </ScrollView>
      <View style={{marginTop: 'auto', marginBottom: 0}}>
        <YFFButton
          ...
          showEnable={frontImageBase64 && backImageBase64 ? true : false}
